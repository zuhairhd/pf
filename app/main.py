...
from app.routers import auth, dashboard, accounts, transactions, budgets, goals, loans, ai as ai_router, notifications, documents, profile, admin, bills, subscriptions, family, reports
